        ...
        <header>
            ...
            <div ref={barRef} className="mobile-side-bar collapsed md:hidden fixed left-0 w-72 top-0 bottom-0 bg-white z-50 p-1 dark:bg-gray-900 dark:text-white">
                <div className='flex items-center mt-1 mb-2'>
                    <form onSubmit={search} action="search" className='flex search border-2 border-red-400 w-full rounded-md p-1'>
                        <label htmlFor="search"><i className="fa-solid fa-magnifying-glass text-red-400 mx-1"></i></label>
                        <input ref={inputRef} id='search' type="text" name='q' placeholder={header.search} className='outline-none w-full placeholder:text-red-400' />
                    </form>
                    <i onClick={closeBar} className="fa-solid fa-xmark mx-2 text-2xl text-red-400 cursor-pointer"></i>
                </div>
                <ul className='text-2xl'>
                    ...
                    <li className='p-2 hover:bg-red-400 hover:text-white'>
                        <select value={currentLang} onChange={changeLang} id="languages" className="bg-transparent outline-none">
                    ...
                    <li className='p-2 hover:bg-red-400 hover:text-white '>
                        <select value={currentCurrency} onChange={changeCurrency} id="currencies" className="bg-transparent outline-none">
                ...
                <div className="container px-5 mx-auto py-3 text-white">
                    <div className="flex justify-center md:justify-between">
                        <div className="contact-box flex items-center">
                            <Link className='pe-3' href={'https://www.facebook.com/'} target='_blank'><i className="fa-brands fa-facebook-f"></i></Link>
                            <Link className='pe-3' href={'https://www.twitter.com/'} target='_blank'><i className="fa-brands fa-twitter"></i></Link>
                            <Link className='pe-3' href={'https://www.plus.google.com/'} target='_blank'><i className="fa-brands fa-google-plus-g"></i></Link>
                            <Link className='pe-3' href={'https://www.pinterest.com/'} target='_blank'><i className="fa-brands fa-pinterest"></i></Link>
                            <Link className='pe-3' href={'https://www.instagram.com/'} target='_blank'><i className="fa-brands fa-instagram"></i></Link>
                        ...
                        <div className="right-box hidden md:flex">
                            ...
                            <select value={currentLang} onChange={changeLang} id="languages" className="bg-transparent outline-none w-fit me-2">
                                <option className='bg-white text-black hover:bg-gray-400' value="en">ENG</option>
                                <option className='bg-white text-black hover:bg-gray-400' value="az">AZE</option>
                                <option className='bg-white text-black hover:bg-gray-400' value="tr">TUR</option>
                            </select>
                            <select value={currentCurrency} onChange={changeCurrency} id="currencies" className="bg-transparent outline-none w-fit border-white border-opacity-30 border-s ps-2">
                                <option className='bg-white text-black hover:bg-gray-400' value="USD">USD</option>
                                <option className='bg-white text-black hover:bg-gray-400' value="AZN">AZN</option>
                                <option className='bg-white text-black hover:bg-gray-400' value="TRY">TRY</option>
                            </select>
            ...
            <div ref={navBarRef} className="lower-nav w-full text-lg dark:text-white dark:bg-gray-900">
                <div className="container mx-auto py-6 px-5">
                    <div className="flex items-center">
                        <button onClick={openBar} className='md:hidden me-6 flex justify-start w-fit text-3xl'><i className="fa-solid fa-bars-staggered"></i></button>
                        ...
                        <div className="right-box grow md:grow-0 md:w-fit flex justify-end">
                            <ul className='flex justify-end'>
                                ...
                                <li className='themeToggle relative ps-2'>
                                    <input ref={checkboxRef} onChange={changeTheme} type="checkbox" className="checkbox checked:checkbox-label" id="checkbox" />
            ...
            <div ref={searchRef} className="searched-box collapsed hidden md:flex fixed z-40 bg-white left-0 right-0 top-0 h-1/6 p-3 items-center dark:bg-gray-900 dark:text-white">
                ...
                <i onClick={closeSearch} className="fa-solid fa-xmark mx-2 text-2xl text-red-400 cursor-pointer"></i>
            </div>
